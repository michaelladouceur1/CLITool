...
select = SSelect(
    message = 'PART NUMBER',
    choices=[f'PPC{random.randrange(100000)}.40' for i in range(100)],
    menu_color=colors.colors['blue'], max_lines=30)
answer = select.run()
print(answer)
# select = SSelect(
#     message = 'WORK CENTER ID',
#     choices=[f'{random.randrange(9999)}' for i in range(20)],
#     menu_color=(144, 252, 202), max_lines=10)
# answer = select.run()
# print(answer)